...
The term "functional training" gets abused. It can mean anything from "BOSU ball single-leg squats with curls" to "kettlebell circuits" to "actual programming for real-world capability." This skill takes the third definition.

**Functional means: trains the body to do things outside the gym better.** Not "looks athletic on Instagram." That requires:

1. Movement patterns over isolation
2. Multi-plane and rotational work
3. Unilateral strength
4. Work capacity (conditioning that translates)
...
3. **Use unstable surfaces only when warranted.** BOSU squats are not more functional than barbell squats. They're worse, in most cases.
4. **Multi-plane > single plane only.** Train sagittal (front-back), frontal (side-side), and transverse (rotational) movement.

## The 7 movement patterns to train every week
...
Most functional clients undertrain mobility. Make it a programming pillar:

- **Daily 10-min mobility work** (joint by joint flow)
- **Pre-session 5–10 min** dynamic mobility specific to the day's work
- **Post-session 5 min** of position-specific holds (deep squat, 90/90, couch stretch)

Train mobility, don't just stretch passively. Loaded ROM, end-range strength, and tissue capacity are the goal.
...
- C. Push-up to single-arm reach 3x6/side (rotation, push)
- D. Suitcase carry 3x40 sec/side (anti-lateral flexion, carry)
...
- C. Half-kneeling overhead press 3x8 (anti-extension, push)
- D. Cable rotational chop 3x10/side (rotation)
...
- B. Goblet squat 3x10
- C. Push press 3x6 (push, power)
- D. Reverse lunge with rotation 3x8/leg (lunge + rotation)
- E. Turkish get-up 3x3/side (full body, integrated)
...
- Weighted vest / sandbag / heavy carry implement
- TRX / rings (gymnastic strength elements)

## Tools that don't usually earn their place

- BOSU ball under squats (unless rehabbing balance)
- Wobble boards under heavy load
- Vibration plates
...
| Pure hypertrophy | Pure strength | Functional |
|---|---|---|
| Muscle growth | Maximal strength | Real-world capability |
| Isolation matters | Compound focus | Movement pattern focus |
| Bodybuilding split | Powerlifting/Olympic | Pattern-based split |
| Cardio minimum | Cardio minimum | Cardio significant |
| Less unilateral | Some unilateral | Heavy unilateral |
| No carries | Some carries | Required carries |
...
Functional clients often *also* want:
- Body recomposition → layer with `body-recomp` (lean toward maintenance calories)
- Joint pain relief → layer with `injury-prep`
