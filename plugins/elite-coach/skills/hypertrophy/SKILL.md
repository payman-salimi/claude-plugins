...
Hypertrophy is a volume-driven goal. The single biggest predictor of growth is **hard sets per muscle group per week**.

| Phase | Hard sets / muscle / week |
|---|---|
| Maintenance | 6–10 |
| Productive growth | 12–20 |
| Peak / overreach | 22–28 (briefly, then deload) |
| Beyond | Diminishing returns, rising injury risk |

Build from the bottom of the range to the top across a 4–6 week block, deload, restart slightly higher.

A "hard set" = within 0–3 reps of failure (RPE 7+).
...
| Rep range | Best for |
|---|---|
| 6–8 | Compound lifts, strength + hypertrophy crossover |
| 8–12 | Most accessory and isolation work |
| 12–20 | Pump work, smaller muscles (arms, calves, rear delts) |
| 20–30 | Metabolic work, finishers |
...
### Chest
- Mid chest: Flat bench (BB or DB), push-ups, machine press
- Upper chest: Incline press (15–30°), incline DB
- Lower chest: Decline press, dips
- Stretch under load: incline DB fly, cable fly with deep stretch

### Back (lats, traps, rhomboids, rear delts)
- Lats vertical: Pull-ups (any grip), lat pulldown
- Lats horizontal/expansion: Cable pullover, dumbbell pullover
- Mid-back / rhomboids: Bent-over row, chest-supported row, T-bar row
- Traps: Deadlift, RDL, shrug
- Rear delts: Reverse pec deck, face pulls, rear delt fly

### Shoulders
- Front delts (already trained by pressing): minimal direct
- Side delts: Lateral raise (DB or cable), upright row (light)
- Rear delts: see Back

### Quads
- Squats (especially front squat, high-bar squat)
- Leg press (high foot bias hams, low foot bias quads)
- Hack squat
- Bulgarian split squat
- Leg extension (great for quads, especially rectus femoris)
...
### Arms
- Biceps: Curl (BB, DB, hammer, cable), preacher curl, incline curl
- Triceps: Skull crusher, overhead extension, pushdown, dips, close-grip bench

Use 2–3 different exercises per muscle group per week to hit different fiber regions and joint angles.
...
- Compound lifts (squat, deadlift, bench, etc.): 2–4 min
- Accessory compounds (incline press, RDL, etc.): 90 sec – 2 min
...
2. Add weight (smallest available jump)
3. Drop back to bottom of rep range
4. Build back up week-over-week

Example: 4x10 lateral raise at 25 lb → hit 10 across all sets at RPE 7 → next session 27.5 lb x 8, build to x 10, repeat.

## Block structure

Run hypertrophy blocks in 4–6 week cycles:
- Week 1: 12 hard sets/muscle
- Week 2: 14
- Week 3: 16
- Week 4: 18 (volume peak)
- Week 5: deload (50% volume)
- Restart at 13–14, slightly higher than last block
