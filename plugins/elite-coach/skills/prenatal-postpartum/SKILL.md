...
3. **No heavy Valsalva (held breath under heavy load).** Cue exhale on exertion through the entire pregnancy and postpartum return.
...
- If she trained before pregnancy, she can largely keep training at slightly reduced intensity. Cap RPE at 7–8.
- Watch for nausea, fatigue. Honor the day's energy.
- No new max efforts. Stop chasing PRs.
- Continue: squats, deadlifts (cap at moderate %), pull-ups, presses (no overhead at heavy %), rows.
- Cardio: maintain pre-pregnancy zones if cleared. Add walking.
...
- Reduce volume. Maintain stimulus, don't chase progress.
...
- Exhale on exertion (the lift)
- Inhale on lowering / eccentric
...
- Urinary leakage with sneezing, jumping, lifting
- Heaviness or pressure "down there"
- Pain with intercourse
- Difficulty stopping the flow of urine

If any red flags: refer to pelvic floor PT first. Build the plan around walking + breathing + glute activation only until she's seen one.

**Once cleared:**

- 2–3 sessions/week, 30–45 min
- Full body, low intensity (RPE 5–7)
- Re-introduce: bodyweight squats, glute bridges, bird dogs, dead bugs, banded rows, push-ups on incline, light goblet squats
- All work paired with breath: exhale on the hard part
- No loaded ab flexion (sit-ups, crunches, V-ups) until diastasis is closed
- No running, jumping, heavy lifting yet

### Weeks 12+: Progressive return

If recovery has gone smoothly and pelvic floor + core are tracking well:

- Add load gradually. Start at 50% of pre-pregnancy lifts at most.
- Re-introduce the main lifts: goblet → barbell squat, RDL, trap bar deadlift, incline press, rows, pull-ups
- Cardio progression: power walks → jog intervals → easy runs by 4–6 months IF no leakage and no heaviness
- Body recomp can become a goal here, but don't aggressively cut while breastfeeding (risk to milk supply). 250–300 cal deficit max if breastfeeding, prioritize protein.
...
- Loaded supine ab work (sit-ups, weighted crunches)
- Anything that produces coning/doming of the abs
- Russian twists, side bends with load
- Heavy bracing without breathing through it
- Box jumps, double-unders, plyometrics (during pregnancy and through ~12 weeks postpartum, longer if leakage)
- Running with pelvic floor symptoms

## Safe staples that work all phases

- Pelvic floor / diaphragmatic breathing
- Bird dog, dead bug (modified for belly in late pregnancy)
- Glute bridge, hip thrust (with care in third trimester)
...
1. Confirm trimester or postpartum week
2. Confirm medical clearance status (no clearance = no program beyond walking/breathing)
